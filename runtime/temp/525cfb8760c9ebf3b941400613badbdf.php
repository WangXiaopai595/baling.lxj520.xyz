<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"C:\wwwroot\baling.cqyxcn.com\public/../application/index\view\index\index.html";i:1520490071;}*/ ?>
<!DOCTYPE html>
<html>
	...
	<body>
		...
		<div class="tab_hd">
			<ul>
				<li class="active">设计案列</li>
				<li>
					<a href="<?php echo url('index/build'); ?>" style="text-decoration:none;color: #333;" >施工档案</a>
				</li>
			</ul>
		</div>
		<div class="div0">
