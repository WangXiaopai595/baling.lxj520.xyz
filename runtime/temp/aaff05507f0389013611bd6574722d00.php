<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:82:"C:\wwwroot\baling.cqyxcn.com\public/../application/admin\view\site\articleadd.html";i:1520911970;s:70:"C:\wwwroot\baling.cqyxcn.com\application\admin\view\public\header.html";i:1517123229;s:70:"C:\wwwroot\baling.cqyxcn.com\application\admin\view\public\footer.html";i:1517123802;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form class="layui-form" id="form">
	...
	<div class="layui-form-item">
		...
		<div class="layui-input-block" style="width: 50%;">
			<textarea placeholder="请输入文章简介" name="sketch" class="layui-textarea"></textarea>
		</div>
	</div>
	...
	<div class="layui-form-item">
		<div class="layui-input-block">
			<button type="button" class="layui-btn" id="button" data-url='<?php echo url("site/articleadd"); ?>' data-succ='<?php echo url("site/index"); ?>'>立即提交</button>
		</div>
	</div>
...
<script>
	$(function(){
		...
		function checkForm(){
			...
			if(!cover){
				layer.msg('请选择封面',{icon:0,time:1000});
				return false;
			}
