<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:81:"C:\wwwroot\baling.cqyxcn.com\public/../application/admin\view\site\banneradd.html";i:1520490370;s:70:"C:\wwwroot\baling.cqyxcn.com\application\admin\view\public\header.html";i:1517123229;s:70:"C:\wwwroot\baling.cqyxcn.com\application\admin\view\public\footer.html";i:1517123802;}*/ ?>
<!DOCTYPE html>
<html lang="en">
<head>
	<meta charset="UTF-8">
...
<form class="layui-form" id="form">
	...
	<div class="layui-form-item">
		<div class="layui-input-block">
			<button type="button" class="layui-btn" id="button" data-url='<?php echo url("site/banneradd"); ?>' data-succ='<?php echo url("site/banner"); ?>'>立即提交</button>
		</div>
	</div>
